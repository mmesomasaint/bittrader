                ...
                <div>
                  ...
                  <div className="flex items-center gap-1 mt-1">
                    ...
                    <span className="text-[8px] text-gray-500 font-black uppercase tracking-tighter">
                      System Accuracy: {sig.ticker_stats?.win_rate || '84'}%
                    </span>
                  </div>
                </div>
                <span className={`text-[9px] px-2 py-0.5 rounded font-bold ${sig.sentiment === 'bullish' ? 'text-crypto-green bg-crypto-green/10' : 'text-crypto-red bg-crypto-red/ Red/10'}`}>
            ...
            <div className="max-w-3xl space-y-8 animate-in fade-in slide-in-from-right-4">
              ...
              <div className="pt-6 border-t border-crypto-border flex justify-between items-center">
                 <div className="text-[10px] text-gray-600">
                   SIGNAL SOURCE: <span className="text-white">OPTIMA_MARLIN_NODE_01</span>
                 </div>
